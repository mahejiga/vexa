...
const LABEL_CONTENEDOR: Record<string, string> = {
...
const LABEL_DISP: Record<string, string> = {
  alta: 'Alta',
  media: 'Media',
  limitada: 'Limitada',
};

const COLOR_DISP: Record<string, string> = {
  alta: '#16a34a',
  media: '#d97706',
  limitada: '#dc2626',
};

export function generarHtmlCotizacion(d: LeadCotizacionData): string {
