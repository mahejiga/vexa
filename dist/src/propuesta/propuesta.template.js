...
exports.generarHtmlPropuesta = generarHtmlPropuesta;
function generarHtmlPropuesta(d) {
    const fmt = (n, dec = 0) => n.toLocaleString('es-CO', { minimumFractionDigits: dec, maximumFractionDigits: dec });
    const filaDos = (label, val) => `
    <tr>
...
//# sourceMappingURL=propuesta.template.js.map